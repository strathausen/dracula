...
describe('Dracula', function () {
  ...
  describe('#addEdge', function () {
    it('create edge', function () {
      ...
      var result = { source: { id: 'a' }, target: { id: 'b' } };
  ...
  describe('#removeEdge', function () {
    it('remove by providing two node ids', function () {
      ...
      var result = { source: { id: 'a', edges: [] }, target: { id: 'b', edges: [] } };
    ...
    it('remove by providing two nodes', function () {
      ...
      var resultEdge = { source: { id: 'a', edges: [] }, target: { id: 'b', edges: [] } };
    ...
    it('remove non-existing edge', function () {
      ...
      var resultEdge = { source: { id: 'a' }, target: { id: 'b' } };
  ...
  describe('#toJSON', function () {
    ...
    var resultEdge = { source: resultSource, target: resultTarget };
